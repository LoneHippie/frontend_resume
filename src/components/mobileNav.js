        ...
        <div className="nav-mobile">
            ...
            <nav className="nav-mobile__nav">
                ...
                <ul className="nav-mobile__list">
                    ...
                    <li className="nav-mobile__item"><button aira-lable="link to my resume" className="nav-mobile__link"><a href="https://drive.google.com/file/d/1R6sVY0Pi2ELCdK7b7EowTWXW68E1nwcD/view?usp=sharing" target="_blank" rel="noreferrer">Resume</a></button></li>
                </ul>
            </nav>
